...
* Add missing log when calling `UserAdbManager#install` ([90b612b](https://github.com/inotia00/revanced-library/commit/90b612bee8591c01b8befabde4147c7de7a2a09f))
* Ask for root permissions before trying to use them ([aea1d69](https://github.com/inotia00/revanced-library/commit/aea1d6915766d9757075ee459955aa335d906bab))
* Catch exceptions when serializing invalid patch options ([cd73bd3](https://github.com/inotia00/revanced-library/commit/cd73bd39ce7be5963a3c84ec43409b87c327579b))
* Check if file exists before trying to open it ([8ddc6e9](https://github.com/inotia00/revanced-library/commit/8ddc6e9d6f3c41c1528e0d43156d7d811dd6be40))
* Delete mount script ([4fe0fb0](https://github.com/inotia00/revanced-library/commit/4fe0fb0a617082b24199331671193e4fa7f485e2))
* Detect if app is installed by fixing inversion ([649f06b](https://github.com/inotia00/revanced-library/commit/649f06b19dd4d2a3f3216a0b3ea947b9fe0d475f))
* Differentiate no package compatibility to any version compatibility ([762b7e3](https://github.com/inotia00/revanced-library/commit/762b7e3bc01e2ca33dfcdbb1b5028d60ef6e0a48))
* Do not specify a provider to automatically select an available one ([249372c](https://github.com/inotia00/revanced-library/commit/249372c31f7e7975fc9eacb5361bd07dbc5dfb92))
* Execute ADB commands sequentially to fix mounting issues ([#12](https://github.com/inotia00/revanced-library/issues/12)) ([fda3eca](https://github.com/inotia00/revanced-library/commit/fda3eca74f30b968d8ee816d63a3dcf493e026de))
* Make functions internal which are supposed to be internal ([893d22d](https://github.com/inotia00/revanced-library/commit/893d22d7938fa1c7544795635ed2ffacdd0cbf0d))
* Make property private ([51109c4](https://github.com/inotia00/revanced-library/commit/51109c476837828535dcd395a5222d2fcf7fc22c))
* Map dependencies from `KClass` into `String` to fix serialization ([57e36ab](https://github.com/inotia00/revanced-library/commit/57e36ab5c15a5fa7c50fb689ee43ad4eb9a4a515))
* Only load the keystore once per instantiation ([5993f7e](https://github.com/inotia00/revanced-library/commit/5993f7e568543c777bee51a140c34fa8953a178a))
* Serialize compatible packages as a map instead of a set of pairs. ([737e272](https://github.com/inotia00/revanced-library/commit/737e272481fe3b0b4c89233d139b5e657a0c1de4))
* Sign APKs using `apksig` ([f59ecbc](https://github.com/inotia00/revanced-library/commit/f59ecbccd14a08d87d4f18c3c0cc47a884088b99))
* Sort the version maps by the most common version ([e4be6db](https://github.com/inotia00/revanced-library/commit/e4be6dbccd86700ffafe7cd8395e845bbd3d5138))
* Support mounting even when Magisk is not installed ([2a30845](https://github.com/inotia00/revanced-library/commit/2a30845f61d5f77ded7a72ee3d6ab55b4c512d52))
* Use `BKS` instead of default signing provider to fix backwards compatibility ([41805fc](https://github.com/inotia00/revanced-library/commit/41805fcb0bdc778fe0870427a0a1caa6d4369cee))
* Use correct function name casing ([ef38d8b](https://github.com/inotia00/revanced-library/commit/ef38d8b4bfe3a79c25fb40588c6217c09574770f))
* Use the JVM name instead of the value from `KClass#toString` ([d18e436](https://github.com/inotia00/revanced-library/commit/d18e436de1df14452ecaa7d827be5e6596ba8a2d))


### Build System

* Refactor to DSL to bump ReVanced Patcher ([7f5d6da](https://github.com/inotia00/revanced-library/commit/7f5d6dad7ba73e2ee53010241ba3204d04860a22))


### Features

* Add `PatchUtils#getMostCommonCompatibleVersions` utility function ([c5f3536](https://github.com/inotia00/revanced-library/commit/c5f3536cbb6997766076595dc0b2b5d2e861ca73))
* add `rip-libs` ([23df153](https://github.com/inotia00/revanced-library/commit/23df153bd66a68b94a8213fda73ea074e1b865ea))
* add compatibility with keystores generated in CLI v3.0 ([907124a](https://github.com/inotia00/revanced-library/commit/907124a7c1ffb2d72e1edd7be9164a8e71540d34))
* Add initial project structure ([833291d](https://github.com/inotia00/revanced-library/commit/833291dc68568f11afbf00e443cc857313489424))
* Add JSON de- and serialization of patches ([ecff6fe](https://github.com/inotia00/revanced-library/commit/ecff6fe0d3889d729a0badcfa28b89610bd27d48))
* Add local Android installer ([#25](https://github.com/inotia00/revanced-library/issues/25)) ([43d655a](https://github.com/inotia00/revanced-library/commit/43d655aea5d86288ae9916630e0f30de219d5cfb))
* Add utility function around key certificate pairs ([2df3484](https://github.com/inotia00/revanced-library/commit/2df3484b68ed72338a52e76fb4b7ceb9c9c644ed))
* Allow getting most common compatible versions for all packages ([96845ba](https://github.com/inotia00/revanced-library/commit/96845ba265e6dc208c7ac96f5e58734209cd1720))
* Improve exception message ([b15efa4](https://github.com/inotia00/revanced-library/commit/b15efa41f8dc7d73865d0eab15be274b9ee3d7a3))
* Improve mount reliability by unmounting existing mounts and killing running apps ([9fda407](https://github.com/inotia00/revanced-library/commit/9fda40744173669c84b0c2599ae5ac5d39591798))
* Increase certainty of the possibility to mount ([10f8cd1](https://github.com/inotia00/revanced-library/commit/10f8cd1470fd29cfefe53bf00a4a014f71a3f706))
* Increase default expiration date of certificate ([f2bd3f5](https://github.com/inotia00/revanced-library/commit/f2bd3f5eeee14ca32094be0d41c32b231a16bcc3))
* Increase the key size to 4096 ([892e083](https://github.com/inotia00/revanced-library/commit/892e0835c6b2da0836bd6ba1d8603db1848cc2d9))
* Log warnings when compiling resources ([1dc8e2e](https://github.com/inotia00/revanced-library/commit/1dc8e2e2eb76bcade9167be0c4b4a628ff114f63))
* Mention APK file name when logging aligning ([244ebc2](https://github.com/inotia00/revanced-library/commit/244ebc21868c07d1852857f6858c1a53a5561155))
* Remove deprecated functions ([b9bf3bc](https://github.com/inotia00/revanced-library/commit/b9bf3bc88284c0381c7370c3606b662da2ef380d))
* revert Options object ([99d81d1](https://github.com/inotia00/revanced-library/commit/99d81d16b09a493fc81f212e88c3bf4fd7217a67))
* Select first Adb device, if none supplied automatically ([1a5f868](https://github.com/inotia00/revanced-library/commit/1a5f868ecd0d278d574c12664ee95139c2423c17))
* Simplify signing utility API ([4c6a636](https://github.com/inotia00/revanced-library/commit/4c6a6360cf83659d1f5c3a7c5710ac54426e9235))
* Use `apkzlib` instead of own implementations and bump ReVanced Patcher ([3aa6dc2](https://github.com/inotia00/revanced-library/commit/3aa6dc223a9a1a2f735eda407917548ecbd366aa))
* Use better log messages when handling exceptions ([5896968](https://github.com/inotia00/revanced-library/commit/58969683582e70f36d6ed169b41c37928a2cf602))
* Warn when option could not be set because the option does not exist ([7ec6504](https://github.com/inotia00/revanced-library/commit/7ec650461935faf2a8fbb667db3cf137157b70b5))


### Performance Improvements

* Use maps to set options ([13823b7](https://github.com/inotia00/revanced-library/commit/13823b74db1de3a104b5022b6bf0db0ef945f47b))
